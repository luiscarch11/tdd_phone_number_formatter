...
void main() {
  group('main functionality for processing phone numbers with NumberProcesser',
    ...
    test(
      'NumberProcessed(112-154-4-4--).processedNumber should return 112-154-44',
      () {
        final classInstance = NumberProcesser('112-154-4-4--');
        expect(classInstance.processedNumber, '112-154-44');
      },
    );
  });
}
